...
public _tokenContractAddress: string = "0xb2ee73f29f6130967aa9769f742ae1287be2e988";
  ...
  public async increase_ether(bid,amt): Promise<number> {                               //increase betted ETher
  let meta=this;
  let account:string = '';
      await this.getAccount().then(address => this.account = address);     
  return new Promise((resolve, reject) => {
  ...
  public async increase_token(bid,amt): Promise<number> {     
    let meta=this;
    let account:string = '';
      await this.getAccount().then(address => this.account = address);  
  return new Promise((resolve, reject) => {
  ...
  public async decrease_ether(bid,amt): Promise<number> {                               //decrease betted ETher
  let meta=this;
  let account:string = '';
      await this.getAccount().then(address => this.account = address);     
  return new Promise((resolve, reject) => {
  ...
  public async decrease_token(bid,amt): Promise<number> {     
  ...
  public async cancel_bet(bid): Promise<number> {     
